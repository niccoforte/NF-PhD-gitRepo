...
def parse_args():
    parser = argparse.ArgumentParser(description="HPC GPU HPO run for the UT MLP stress-strain model.")
    ...
    parser.add_argument("--name", default="MLP_full_hOpt")
...
def main():
    ...
    print(f"Split sizes: {split_size_summary(dat_mlp)}")
    ...
    study = hOpt_model(
        ...
        loss_space=mlp_loss_space,
        train_space=mlp_train_space,
        seed=args.seed,
        device=device,
        save=True,
