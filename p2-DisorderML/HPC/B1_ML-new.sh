...
#   sbatch B1_ML-new.sh CurveOutputs/A0-HPC_Curve-test.py --epochs 3 --nsims 64
#   ML_SCRIPT=FieldOutputs/A0-HPC_Field-test.py RUN_LABEL=trial-field-tr sbatch B1_ML-new.sh -- --epochs 3
#   ML_SCRIPT=FieldToCurveOutputs/A0-HPC_FieldToCurve-test.py RUN_LABEL=trial-field-to-curve sbatch B1_ML-new.sh -- --epochs 3 --nsims 64
#
