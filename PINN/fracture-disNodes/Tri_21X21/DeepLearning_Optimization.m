...
networkDiagrams = 'G:\FractureToughness_ANN\MATLAB_ANN\BrittleMaterial\Tri_21X21';
dataLocation = 'G:\FractureToughness_ANN\ABAQUS\BrittleMaterial';

cd 'G:\FractureToughness_ANN\PythonCode'
nodes_per = importINPfile('tri_21X21per.inp',18,467+18-1);
nodes_per(:,1) = [];

perNodalArray = zeros(1,467*2);
...
cd (dataLocation)
load('inputData_BrittleMaterialtri.mat');
...
for i=1:5
    iniCoords = [2736 988 2065 1311 2093];
    x0 = radData(iniCoords(i),:); %2736 988 2065 1311 2093
