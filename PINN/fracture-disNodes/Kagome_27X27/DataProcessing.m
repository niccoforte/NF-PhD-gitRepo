...
numData = 3000;
numNode = 2211; %FCC = 912, tri = 467, kagome = 2211
nnx = 27;
nny = nnx;

cd 'G:\FractureToughness_ANN\PythonCode'
nodes_per = importINPfile('kagome_27X27per.inp',18,numNode+18-1);
nodes_per(:,1) = [];
...
cd (dataFileLoc)
inputDataFileName = strcat(['inputData_',material,latticeType,'2']);
outputDataFileName = strcat(['outputData_',material,latticeType,'2']);
