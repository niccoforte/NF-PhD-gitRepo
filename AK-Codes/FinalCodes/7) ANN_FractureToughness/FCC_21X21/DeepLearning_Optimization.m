...
networkDiagrams = 'G:\FractureToughness_ANN\MATLAB_ANN\BrittleMaterial\FCC_21X21';
dataLocation = 'G:\FractureToughness_ANN\ABAQUS\BrittleMaterial';

cd 'G:\FractureToughness_ANN\PythonCode'
nodes_per = importINPfile('FCC_21X21per.inp',18,912+18-1);
nodes_per(:,1) = [];

perNodalArray = zeros(1,912*2);
...
cd (dataLocation)
load('inputData_BrittleMaterialFCC.mat');
...
for i=1:5
    iniCoords = [37 117 374 1546 1291];
    x0 = radData(iniCoords(i),:); %37 117 374 1546 1291
...
plot([70 150],[70 150],'--k','LineWidth',1.5)
xlim([70 150])
ylim([70 150])
