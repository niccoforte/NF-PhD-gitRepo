...
layers = [
    featureInputLayer(size(radData,2),'Normalization', 'rescale-zero-one')
...
%     reluLayer
    ...
    qlmseRegressionLayerCustom('qlmse')]; %regressionLayer];
...
stressPred = predict(net,XTest(modelNum,:),'MiniBatchSize',miniBatchSize);
