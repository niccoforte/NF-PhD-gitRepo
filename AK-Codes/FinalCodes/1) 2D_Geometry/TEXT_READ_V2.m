...
fprintf('*Node\n');
node_TEXT    = '%d, %d, %d, %d\n';
fprintf(node_TEXT,1,unitCellSize*nnx,unitCellSize*nny,0.);

fprintf('*Node\n');
node_TEXT    = '%d, %d, %d, %d\n';
fprintf(node_TEXT,2,unitCellSize*nnx,unitCellSize*nny+50,0.);

fprintf('*Node\n');
node_TEXT    = '%d, %d, %d, %d\n';
fprintf(node_TEXT,3,unitCellSize*nnx+50,unitCellSize*nny,0.);
