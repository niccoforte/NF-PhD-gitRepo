...
nny = 10                        # number of Unit cells in Y direction
fac = 0.2                       # distortion
elemSize = 0.5                  # minimum element size
relDensity = 0.01               # relative density
strainApp = 0.03
...
for idNum in range(initial,numOfJobs):
    ...
    if (MechanicalModel.lower() == 'fracture' or MechanicalModel.lower() == 'both'):
        ...
        xCrE = [0.25*(L/1.25)+0.25*(L/1.25), H/2+unitCellSize*0.2]     # crack end point topRight
